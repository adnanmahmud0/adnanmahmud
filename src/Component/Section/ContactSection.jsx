...
const ContactSection = () => {
  return (
    <div className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-7xl bg-white">
      <div>
        <h1 className="text-gray-800 text-3xl font-extrabold">Contact information        </h1>
          ...
          <ul className="mt-4">
            <li className="flex items-center">
              ...
              <a href="javascript:void(0)" className="text-[#007bff] text-sm ml-4">
                ...
                <strong>dev.adnanmahmud@gmail.com</strong>
              </a>
            </li>
          </ul>
        </div>
      ...
      <form className="ml-auto space-y-4">
        ...
        <button type='button' className="text-white bg-blue-500 hover:bg-blue-600 tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6">Send</button>
      </form>
    </div>
  );
};
